...
public class DrawingJPanel extends JPanel {
	...
	private BarCodeCreator barCode;
	private JCheckBox jCheckBoxImage;
	private JCheckBox jCheckBoxLine;
	private JCheckBox jCheckBoxShape;
	private JCheckBox jCheckBoxTextBox;
	private JCheckBox jCheckBoxBarCode;
	...
	public DrawingJPanel() {
		...
		JButton jButtonDrawing = new JButton();
		JLabel jLabel1 = new JLabel();
		jCheckBoxImage = new JCheckBox();
		jCheckBoxLine = new JCheckBox();
		jCheckBoxShape = new JCheckBox();
		jCheckBoxTextBox = new JCheckBox();
		jCheckBoxBarCode = new JCheckBox();
		...
		jLabelDescription.setText("Excel 操作・編集 - 図、シェイプの設定");
		...
		jTextArea1.setText("ExcelCreator の機能でオブジェクト(図、シェイプ)を挿入します。");
		jTextArea1.setAutoscrolls(false);
		jTextArea1.setOpaque(false);
		jScrollPane1.setViewportView(jTextArea1);

		jPanel1.setBorder(BorderFactory.createTitledBorder(null, "オブジェクト", 0, 0, new java.awt.Font("Meiryo UI", 0, 13)));
		jPanel1.setFont(new java.awt.Font("Meiryo UI", 0, 13));
		jPanel1.setOpaque(false);
		jPanel1.setPreferredSize(new java.awt.Dimension(443, 159));

		jButtonDrawing.setFont(new java.awt.Font("Meiryo UI", 0, 13));
		jButtonDrawing.setText("Excel ファイル作成");
		jButtonDrawing.setPreferredSize(new java.awt.Dimension(130, 30));
		jButtonDrawing.addActionListener(new java.awt.event.ActionListener() {
			@Override
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				jButtonDrawingActionPerformed(evt);
			}
		});

		jLabel1.setFont(new java.awt.Font("Meiryo UI", 0, 13));
		jLabel1.setText("チェック ON のオブジェクトを挿入した Excel ファイルを作成します。");

		jCheckBoxImage.setFont(new java.awt.Font("Meiryo UI", 0, 13));
		jCheckBoxImage.setSelected(true);
		jCheckBoxImage.setText("図の挿入");
		jCheckBoxImage.setBackground(new java.awt.Color(248, 248, 255));

		jCheckBoxBarCode.setFont(new Font("Meiryo UI", Font.PLAIN, 13));
		jCheckBoxBarCode.setSelected(true);
		jCheckBoxBarCode.setText("バーコード");
		jCheckBoxBarCode.setBackground(new java.awt.Color(248, 248, 255));

		jCheckBoxLine.setFont(new java.awt.Font("Meiryo UI", 0, 13));
		jCheckBoxLine.setSelected(true);
		jCheckBoxLine.setText("ライン");
		jCheckBoxLine.setBackground(new java.awt.Color(248, 248, 255));

		jCheckBoxShape.setFont(new java.awt.Font("Meiryo UI", 0, 13));
		jCheckBoxShape.setSelected(true);
		jCheckBoxShape.setText("オートシェイプ");
		jCheckBoxShape.setBackground(new java.awt.Color(248, 248, 255));

		jCheckBoxTextBox.setFont(new java.awt.Font("Meiryo UI", 0, 13));
		jCheckBoxTextBox.setSelected(true);
		jCheckBoxTextBox.setText("テキストボックス");
		jCheckBoxTextBox.setBackground(new java.awt.Color(248, 248, 255));
				...
				.addGroup(jPanel1Layout.createSequentialGroup()
					.addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(jPanel1Layout.createSequentialGroup()
							...
							.addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING)
								.addGroup(jPanel1Layout.createSequentialGroup()
									.addComponent(jCheckBoxBarCode)
									.addGap(35)
									.addComponent(jCheckBoxLine))
								.addComponent(jCheckBoxTextBox)))
						.addGroup(jPanel1Layout.createSequentialGroup()
							.addContainerGap()
							.addComponent(jButtonDrawing, GroupLayout.PREFERRED_SIZE, 140, GroupLayout.PREFERRED_SIZE)))
			...
			jPanel1Layout.createParallelGroup(Alignment.TRAILING)
				.addGroup(jPanel1Layout.createSequentialGroup()
					...
					.addGroup(jPanel1Layout.createParallelGroup(Alignment.BASELINE)
						...
						.addComponent(jCheckBoxTextBox))
					.addGap(18)
					.addComponent(jButtonDrawing, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
	...
	// 図、シェイプの設定
	private void jButtonDrawingActionPerformed(java.awt.event.ActionEvent evt) {
		// インスタンス生成
		xlsxCreator = new XlsxCreator();
		barCode = new BarCodeCreator();
		filePath = SampleWork.getInDirectory();
		outFileName = SampleWork.getOutDirectory() + "drawing.xlsx";    // 生成 Excel ファイル
		...
		//================================================================//
		// 図の挿入
		if (jCheckBoxImage.isSelected() == true) {
			// 「画像の挿入」用のシートを作成
			AddSheet("画像の挿入");
			...
			xlsxCreator.getCell("B4").getDrawing().addImage(filePath + "image.bmp", 320, 240);

			xlsxCreator.getCell("G2").setStr("1-2. オフセット座標で貼り付け(画像ファイル)");
			xlsxCreator.getCell("G3").setStr("G4 セルを基点に開始位置を調整(20px, 30px)");
			xlsxCreator.getCell("G4").getDrawing().addImage(filePath + "image.bmp", 20, 30, -1, -1, 320, 240);

			xlsxCreator.getCell("L2").setStr("1-3. セルサイズに合わせて貼り付け(画像ファイル)");
			xlsxCreator.getCell("L3").setStr("L4:O13 セル範囲指定");
			xlsxCreator.getCell("L4:O13").getDrawing().addImage(filePath + "image.bmp");
			...
			try {
				imageBmp = ImageIO.read(new File(filePath + "image.bmp"));
			} catch (Exception e) {
				imageBmp = null;
			}
			...
			xlsxCreator.getCell("B32").getDrawing().addImage(filePath + "image.bmp", 320, 240);

			xlsxCreator.getCell("G31").setStr("2-2. png 形式(透過)");
			xlsxCreator.getCell("G32").getDrawing().addImage(filePath + "image.png", 320, 240);
			xlsxCreator.getCell("H36").setValue("セルの文字列が透過");

			xlsxCreator.getCell("L31").setStr("2-3. gif 形式(透過)");
			xlsxCreator.getCell("L32").getDrawing().addImage(filePath + "image.gif", 320, 240);
			xlsxCreator.getCell("M36").setValue("セルの文字列が透過");

			xlsxCreator.getCell("B45").setStr("2-4. jpg 形式");
			xlsxCreator.getCell("B46").getDrawing().addImage(filePath + "image.jpg", 320, 240);
		}
		// バーコード
		...
		// ライン
		if (jCheckBoxLine.isSelected() == true) {
			AddSheet("線の挿入");
			xlsxCreator.setMargin(5, 5, 5, 5, 5, 5);
			xlsxCreator.setPaperSize(PageOrientation.Landscape, PaperKind.A4);
		...
		// オートシェイプ
		if (jCheckBoxShape.isSelected() == true) {
			AddSheet("オートシェイプ");
			xlsxCreator.setMargin(5, 5, 5, 5, 5, 5);
			xlsxCreator.setPaperSize(PageOrientation.Landscape, PaperKind.A4);
		...
		// テキストボックス
		if (jCheckBoxTextBox.isSelected() == true) {
			AddSheet("テキストボックス");
			xlsxCreator.setMargin(5, 5, 5, 5, 5, 5);
			xlsxCreator.setPaperSize(PageOrientation.Landscape, PaperKind.A4);
