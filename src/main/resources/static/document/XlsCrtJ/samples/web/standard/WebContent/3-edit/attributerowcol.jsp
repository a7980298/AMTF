...
<body>
	...
	<form id="form1" action="<%=request.getContextPath()%>/AttributeRowColServlet" method="post">
		<!-- Contents Main -->
		<div class="column-contents">
			...
			<div class="column-contents-1">
				<article class="article">
					...
					<h2>
						<i class="fa fa-chevron-right"></i>行列操作
					</h2>
					<p>ExcelCreator の機能で行列の各操作を行います。</p>
					<p>
						<i class="fa fa-square"></i>行の操作
					</p>
					<p>行の挿入、クリア、削除、コピー/貼り付け、コピー/挿入を行います。</p>
					<p>
						<input type="submit" name="templateopen1" value="テンプレートを確認" style="width: 150px;" />
					</p>
					<p>
						<input type="submit" name="editrow" value="Excel ファイル作成" style="width: 150px;" />
					</p>
					<hr />
					<p>
						<i class="fa fa-square"></i>列の操作
					</p>
					<p>列の挿入、クリア、削除、コピー/貼り付け、コピー/挿入を行います。</p>
					<p>
						<input type="submit" name="templateopen2" value="テンプレートを確認" style="width: 150px;" />
					</p>
					<p>
						<input type="submit" name="editcol" value="Excel ファイル作成" style="width: 150px;" />
					</p>
					<hr />
					<p>
						<i class="fa fa-square"></i>行の高さ、列幅の操作
					</p>
					<p>行の高さ、列幅の編集を行います。</p>
					<p>
						<input type="submit" name="editrowcol" value="Excel ファイル作成" style="width: 150px;" />
					</p>
					<p class="annotation1">※サンプルコードは「src/servlet/AttributeRowColServlet.java」を参照してください。</p>
