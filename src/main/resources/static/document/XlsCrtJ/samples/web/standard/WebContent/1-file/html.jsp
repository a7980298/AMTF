...
<body>
	...
	<form id="form1" action="<%=request.getContextPath()%>/HtmlServlet" method="post">
		<!-- Contents Main -->
		<div class="column-contents">
			...
			<div class="column-contents-1">
				<article class="article">
					...
					<h2>
						<i class="fa fa-chevron-right"></i>ファイル作成（HTML 出力）
					</h2>
					<p>作成した Excel ファイルを元に HTML ファイルの出力を行います。</p>
					<p>
						<i class="fa fa-square"></i>HTML 出力
					</p>
					<p>
