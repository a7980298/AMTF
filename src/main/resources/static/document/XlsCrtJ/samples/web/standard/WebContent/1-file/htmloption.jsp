...
<body>
	...
	<form id="form1" action="<%=request.getContextPath()%>/HtmlOptionServlet" method="post">
		<!-- Contents Main -->
		<div class="column-contents">
			...
			<div class="column-contents-1">
				<article class="article">
					...
					<h2>
						<i class="fa fa-chevron-right"></i>ファイル作成（HTML オプション）
					</h2>
					<p>出力 HTML ファイルの各種設定を行います。</p>
					<p>
						<i class="fa fa-square"></i>HTML オプション
					</p>
					<p>
						<label style="display:inline-block;width:120px;">DocType</label>
						<select name="doctype" size="1">
							<option value="0">Html4</option>
							<option value="1">Html5</option>
						</select>
					</p>
					<p>
						<label style="display:inline-block;width:120px;">HTML タイトル</label>
						<input type="text" name="title" size="20" style="width: 300px" value="ExcelCreator for Java" />
					</p>
					<p>
						<input type="submit" name="templateopen" value="テンプレートを確認" style="width: 150px;" />
					</p>
					<p>
						<input type="submit" name="htmloutput" value="HTML ファイル作成" style="width: 150px;" />
					</p>
					<p class="annotation1">※サンプルコードは「src/servlet/PdfServlet.java」を参照してください。</p>
