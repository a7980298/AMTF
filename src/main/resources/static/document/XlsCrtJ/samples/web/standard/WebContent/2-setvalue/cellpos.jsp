...
<body>
	...
	<form id="form1" action="<%=request.getContextPath()%>/CellPosServlet" method="post">
		<!-- Contents Main -->
		<div class="column-contents">
			...
			<div class="column-contents-1">
				<article class="article">
					...
					<h2>
						<i class="fa fa-chevron-right"></i>値の設定（セルの指定方法）
					</h2>
					<p>値を差し込むセルの指定は、"A1 参照形式"、"座標形式"、"セルの名前"、"変数名" の 4 つの指定方法を使用することができます。</p>
					<p>
						<i class="fa fa-square"></i>セルの指定方法
					</p>
					<p>
						<input type="submit" name="templateopen" value="テンプレートを確認" style="width: 150px;" />
					</p>
					<p>
						<input type="submit" name="cellpos" value="Excel ファイル作成" style="width: 150px;" />
					</p>
					<p class="annotation1">※サンプルコードは「src/servlet/CellPosServlet.java」を参照してください。</p>
