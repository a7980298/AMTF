...
<body>
	...
	<form id="form1" action="<%=request.getContextPath()%>/PdfServlet" method="post">
		<!-- Contents Main -->
		<div class="column-contents">
			...
			<div class="column-contents-1">
				<article class="article">
					...
					<h2>
						<i class="fa fa-chevron-right"></i>ファイル作成（PDF 出力）
					</h2>
					<p>作成した Excel ファイルを元に PDF ファイルの出力を行います。</p>
					<p>
						<i class="fa fa-square"></i>PDF 出力
					</p>
					<p>
						<input type="submit" name="templateopen" value="テンプレートを確認" style="width: 150px;" />
					</p>
					<p>
						<input type="submit" name="pdf" value="PDF ファイル作成" style="width: 150px;" />
					</p>
