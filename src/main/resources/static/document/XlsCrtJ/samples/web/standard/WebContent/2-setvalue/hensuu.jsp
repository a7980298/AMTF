...
<body>
	...
	<form id="form1" action="<%=request.getContextPath()%>/HensuuServlet" method="post">
		<!-- Contents Main -->
		<div class="column-contents">
			...
			<div class="column-contents-1">
				<article class="article">
					...
					<h2>
						<i class="fa fa-chevron-right"></i>値の設定（変数名の使用例）
					</h2>
					<p>
						変数名を使用することでテキストボックスへの値の挿入が可能になります。<br />同一の変数名が複数のセルに配置されている場合、すべてのセルに値が挿入されます。<br />テンプレート Excel 側でレイアウトの変更(行列の追加、削除によるセル移動)があった場合でも、コードを編集することなく目的のセルに対して値の挿入が可能です。
					</p>
					<p>
						<i class="fa fa-square"></i>変数名を使用した値の設定
					</p>
					<p>
						<input type="submit" name="templateopen1" value="テンプレートを確認" style="width: 150px;" />
					</p>
					<p>
						<input type="submit" name="hensuu" value="Excel ファイル作成" style="width: 150px;" />
					</p>
					<p>
						<i class="fa fa-square"></i>変数名キーワード文字列の変更
					</p>
					<p>変数名のキーワード文字列を変更することが可能です。（既定値 "**" アスタリスク 2 つ）</p>
					<ul>
						<li class="check-square"><i class="fa fa-check"></i>最大 64 文字</li>
						<li class="check-square"><i class="fa fa-check"></i>Excel で文字として認識可能で、かつ、 半角文字のみ指定可能</li>
						<li class="check-square"><i class="fa fa-check"></i>「\」、「'」、「"」、「,」、「^」、「.」、「[」、「]」は使用不可</li>
					</ul>
					<p>
						<input type="submit" name="templateopen2" value="テンプレートを確認" style="width: 150px;" />
					</p>
					<p>
						<label style="margin-right: 15px">キーワード文字列</label><input type="text" name="strkeyword" size="20" style="width: 100px" value="--" />
					</p>
					<p>
						<input type="submit" name="keyword" value="Excel ファイル作成" style="width: 150px;" />
					</p>
					<p class="annotation1">※サンプルコードは「src/servlet/HensuuServlet.java」を参照してください。</p>
