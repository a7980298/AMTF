...
public class AccessToken {
	...
	public static byte[] generateSignature(String appCertificate, String appID, String channelName, String uid,
	...
	public boolean fromString(String token) {
		...
		try {
			...
			Utils.unpack(
					Utils.base64Decode(token.substring(Utils.VERSION_LENGTH + Utils.APP_ID_LENGTH, token.length())),
					packContent);
