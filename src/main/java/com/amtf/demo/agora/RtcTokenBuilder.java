...
public class RtcTokenBuilder {
	public enum Role {
		 ...
		 *       Role_Subscriber still has the same privileges as Role_Publisher.
		 */
		Role_Subscriber(2),
		/**
		 * DEPRECATED. Role_Attendee has the same privileges as Role_Publisher.
	 ...
	 *                       string format. The string length must be less than 64
	 *                       bytes. Supported character scopes are:
	 *                       <ul>
	 ...
	 *                       " {", "}", "|", "~", ",".
	 *                       </ul>
	 * @param uid            User ID. A 32-bit unsigned integer with a value ranging
	 *                       from 1 to (2^32-1).
	 * @param role           The user role.
	 *                       <ul>
	 *                       <li>Role_Publisher = 1: RECOMMENDED. Use this role for
	 *                       a voice/video call or a live broadcast.</li>
	 *                       <li>Role_Subscriber = 2: ONLY use this role if your
	 *                       live-broadcast scenario requires authentication for
	 *                       [Hosting-in](https://docs.agora.io/en/Agora%20Platform/terms?platform=All%20Platforms#hosting-in).
	 *                       In order for this role to take effect, please contact
	 *                       our support team to enable authentication for
	 *                       Hosting-in for you. Otherwise, Role_Subscriber still
	 *                       has the same privileges as Role_Publisher.</li>
	 *                       </ul>
	 * @param privilegeTs    Represented by the number of seconds elapsed since
	 *                       1/1/1970. If, for example, you want to access the Agora
	 *                       Service within 10 minutes after the token is generated,
	 *                       set expireTimestamp as the current time stamp + 600
	 *                       (seconds).
	 */
